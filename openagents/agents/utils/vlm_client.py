...
if __name__ == "__main__":
    ...
    vlm_client = VLMClient(model_path="/share_data/checkpoints/train/mc-motion-coa-qwen2-vl-7b-250809-A800-c32-e1-b8-a1/checkpoint-3850",if_token_ids=False,base_url="http://localhost:11000/v1",mode="online",get_sampled_logprobs=1)
    vlm_client.reset()
    messages = []
