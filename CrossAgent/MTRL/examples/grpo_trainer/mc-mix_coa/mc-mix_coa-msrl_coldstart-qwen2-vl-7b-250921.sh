...
experiment_name='mc-mix_coa-msrl_coldstart-qwen2-vl-7b-250911'
...
python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.model.path=/share/hkc/checkpoints/msrl_coldstart/mc-mix_coa-msrl_coldstart-qwen2-vl-7b-250911-A800-e1-b4-a1-s19456/checkpoints/global_step_400/hf_ckpt \
