...
experiment_name='mix_coa'
# We only use data preparation to indicate the modality and the data size.
python3 MC-verl-agent/examples/data_preprocess/prepare.py \
    --mode 'text' \
...
python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.model.path=/share/hkc/checkpoints/msrl_coldstart/mc-openha-state2-qwen2-vl-7b-mix_250929-A800-e1-b4-a1-s19456/checkpoints/global_step_200/hf_ckpt \
