...
project_name='verl_mix'
experiment_name='mc-mix-coa-qwen2-vl-7b-250819'

python3 -m verl.trainer.main_ppo \
    algorithm.adv_estimator=grpo \
    custom_reward_function.path=OpenHA/rl/custom_reward_funcs/mix_vla.py \
    data.train_files=OpenHA/rl/datasets/mc-mix-action/train.parquet \
    data.val_files=OpenHA/rl/datasets/mc-mix-action/valid.parquet \
