...
experiment_name='mc-mix_coa-rl_stage1-qwen2-vl-7b-250906-A800-e1-b4-a1-s19456'
...
RAY_DEBUG=legacy python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.model.path=/share/hkc/checkpoints/ssrl_coldstart/mc-mix_coa-rl_stage1-qwen2-vl-7b-250906-A800-e1-b4-a1-s19456/checkpoints/global_step_400/hf_ckpt \
