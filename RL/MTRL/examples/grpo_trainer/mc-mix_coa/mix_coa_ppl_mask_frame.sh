...
project_name='asyncRL'
experiment_name='mix_coa_ppl_mask_frame_0.9maskrate'
# We only use data preparation to indicate the modality and the data size.
# python MC-verl-agent/examples/data_preprocess/prepare.py \
#     --mode 'text' \
...
python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.model.path=/share/hkc/checkpoints/msrl_coldstart/mc-openha-state2-qwen2-vl-7b-mix_251103-A800-e1-b4-a1-s19456/checkpoints/global_step_200/hf_ckpt \
    ...
    trainer.ppl_mask_ratio=0.0 \
    trainer.ppl_mask_frame_ratio=0.9 \
