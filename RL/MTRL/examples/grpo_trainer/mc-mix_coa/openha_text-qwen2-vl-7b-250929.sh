...
python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.model.path=/share/hkc/checkpoints/msrl_coldstart/mc-openha-state2-qwen2-vl-7b-text_250929-A800-e1-b4-a1-s19456/checkpoints/global_step_200/hf_ckpt \
