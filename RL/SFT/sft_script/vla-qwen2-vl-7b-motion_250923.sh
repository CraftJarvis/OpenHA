...
dataset_paths="OpenHA/rl/datasets/sft/msrl_coldstart/20250923/mc-msrl_coldstart-motion_250923-train-withsystem.jsonl" #"/DATA/lmy/datasets/mc-mix_vla-0827-train.jsonl" 
real_dataset_len=4000 # 900000/2
base_model_path="/share_data/limuyao/checkpoints/train/mc-openha-state2-qwen2-vl-7b-250830-A800-e1-b4-a1/checkpoints/global_step_600/hf_ckpt/" 
version="mc-openha-state2-qwen2-vl-7b-motion_250923" #stage2
